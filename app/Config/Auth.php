...
class Auth extends ShieldAuth
{
  ...
  // Enable Email Activation on registration
public array $actions = [
    'register' => \CodeIgniter\Shield\Authentication\Actions\EmailActivator::class,
    'login'    => null,
];

// Make sure allowRegistration is true

// Optional: redirect after activation



// Activation link lifetime (optional, default 24 hours)
public int $activationLifetime = 24 * 60 * 60; // seconds
