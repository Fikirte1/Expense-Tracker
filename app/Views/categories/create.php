            ...
            <div class="col-md-6 mx-auto">
                        ...
                        <form action="<?= site_url('categories/store') ?>" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       name="name" 
                                       value="<?= old('name') ?>" 
                                       placeholder="Enter category name (e.g., Food, Transport, etc.)"
                                       required
                                       autofocus>
                                <div class="form-text">
                ...
                <div class="card mt-4">
                    <div class="card-header">
                        <h6 class="mb-0"><i class="fas fa-lightbulb me-2"></i>Tips for Good Categories</h6>
                    </div>
                    <div class="card-body">
                        <ul class="mb-0">
                            <li>Use clear, descriptive names</li>
                            <li>Keep categories broad but meaningful</li>
                            <li>Examples: Food & Dining, Transportation, Entertainment, Bills & Utilities</li>
                        </ul>
                    </div>
                </div>
            </div>
